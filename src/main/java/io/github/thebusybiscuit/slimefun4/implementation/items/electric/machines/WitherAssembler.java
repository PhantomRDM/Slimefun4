...
public class WitherAssembler extends AbstractEntityAssembler<Wither> {
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        preset.addItem(1, new CustomItem(getHead(), "&7凋零骷髏頭槽", "", "&f可以放入凋零骷髏頭"), ChestMenuUtils.getEmptyClickHandler());
        preset.addItem(7, new CustomItem(getBody(), "&7靈魂沙槽", "", "&f可以放入靈魂沙"), ChestMenuUtils.getEmptyClickHandler());
