...
public class IronGolemAssembler extends AbstractEntityAssembler<IronGolem> {
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        preset.addItem(1, new CustomItem(getHead(), "&7雕刻過的南瓜槽", "", "&f可以放入雕刻過的南瓜"), ChestMenuUtils.getEmptyClickHandler());
        preset.addItem(7, new CustomItem(getBody(), "&7鐵磚槽", "", "&f可以放入鐵磚"), ChestMenuUtils.getEmptyClickHandler());
